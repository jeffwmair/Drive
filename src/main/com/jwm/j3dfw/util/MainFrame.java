...
public class MainFrame {
     ...
     * @return
     */
	public static synchronized void startMainFrame(GeometryList geometryList, ControllerDirectory controllerDirectory, Camera cam, int targetFps, int frameWidth, int frameHeight) {
		if (instance != null) {
			return;
		}

		instance = new MainFrame(geometryList, controllerDirectory, cam, targetFps, frameWidth, frameHeight);
	}

	private MainFrame(GeometryList parts, ControllerDirectory controllerDirectory, Camera cam, int targetFps, int frameWidth, int frameHeight) {
