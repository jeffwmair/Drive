...
public class CurveTest {
	...
	public void curveTestTooSmall() {
		...
		boolean excep = false;
		try {
			Curve c = new Curve(vals, 0, 1, CurveDirection.Up);
		} catch (Exception e) {
			excep = true;
		}
	...
	public void curveDomainInvalid() {
		...
		boolean excep = false;
		try {
			Curve c = new Curve(vals, 0, 0, CurveDirection.Up);
		} catch (Exception e) {
			excep = true;
		}
		Assert.assertEquals(true, excep);
	...
	public void curveGetRelValueRpm() {
		...
		Curve c = new Curve(vals, 100, 1500, CurveDirection.Up);
	...
	public void curveGetRelValue() {
		...
		Curve c = new Curve(vals, 1, 5, CurveDirection.Up);
	...
	public void curveDownwardGetRelativeValue() {
		...
		Curve c = new Curve(vals, 0, 1500, CurveDirection.Dn);
	...
	public void curveGetValAtDomainVal() {
		double[] vals = { 1, 2, 3, 4, 5 };
		Curve c = new Curve(vals, 11, 15, CurveDirection.Up);
